<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Build.aspx.cs" Inherits="EJ14.WebForm4"  MasterPageFile="~/MasterPage.master"%>
            ...
            <!--- Sign in end  -->
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegistrationConnectionString %>" SelectCommand="SELECT [Name], [Description], [Provider] FROM [tblProductsBuild]"></asp:SqlDataSource>
                    <asp:GridView ID="GridView1" runat="server" OnRowCommand="RowCommand" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black" Width="353px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2">
                        <Columns>
                            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
                            <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
                            <asp:BoundField DataField="Provider" HeaderText="Provider" SortExpression="Provider" />
                            <asp:ButtonField ButtonType="Button" Text="Request" CommandName="SolicitarBhv"/>
                        </Columns>
