    ...
    public partial class WebForm4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                conn.Open();
                string checkprod = "select count(*) from [tblProductsBuild] where Name ='" + txtName.Text + "'";
            ...
            try
            {
                ...
                if (temp2 == 1)
                {
                    ...
                    if (password2 == Password.Text)
                    {
                        ...
                        string insertQuery = "insert into [tblProductsBuild] (Id, Name, Description, Provider) values (@Id, @Name, @Description, @provider)";
