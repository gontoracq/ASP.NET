    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                conn.Open();
                string checkprod = "select count(*) from [tblVehicles] where Name ='" + txtName.Text + "'";
            ...
            try
            {
                ...
                if (temp2 == 1)
                {
                    ...
                    if (password2 == Password.Text)
                    {
                        ...
                        string insertQuery = "insert into [tblVehicles] (ProductId, Name, Description, Provider) values (@ProductId, @Name, @Description, @provider)";
                ...
                Response.Redirect("VehiclesRep.aspx");
