    ...
    public partial class WebForm3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                conn.Open();
                string checkprod = "select count(*) from [tblHouse] where Name ='" + txtName.Text + "'";
            ...
            try
            {
                ...
                if (temp2 == 1)
                {
                    ...
                    if (password2 == Password.Text)
                    {
                        ...
                        string insertQuery = "insert into [tblHouse] (ProductId, Name, Description, Provider) values (@ProductId, @Name, @Description, @provider)";
                ...
                Response.Redirect("HouseholdAp.aspx");
